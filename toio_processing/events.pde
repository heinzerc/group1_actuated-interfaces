...
void keyPressed() {
  ...
  case '2': //sun
   ...
   int[][] targets5={{368,354,222},{286, 285, 244}};
    ...
    cubes[0].led(1000, 244, 88, 15);
    cubes[1].led(1000, 244, 88, 15);
    cubes[2].led(1000, 244, 88, 15);
    cubes[3].led(1000, 244, 88, 15);
    cubes[4].led(1000, 244, 88, 15);
    cubes[5].led(1000, 244, 88, 15);
  ...
  case '4': // snow
   ...
   int[][] snowTargets5={{368,354,222},{322, 303, 55}};
    ...
    cubes[0].led(1000, 255, 255, 255);
    cubes[1].led(1000, 255, 255, 255);
    cubes[2].led(1000, 255, 255, 255);
    cubes[3].led(1000, 255, 255, 255);
    cubes[4].led(1000, 255, 255, 255);
    cubes[5].led(1000, 255, 255, 255);
  ...
  case '5': //wind
   ...
   int[][] windTargets5={{368,354,222}, {246,290,180}};
    ...
    cubes[0].led(1000, 0, 255, 0);
    cubes[1].led(1000, 0, 255, 0);
    cubes[2].led(1000, 0, 255, 0);
    cubes[3].led(1000, 0, 255, 0);
    cubes[4].led(1000, 0, 255, 0);
    cubes[5].led(1000, 0, 255, 0);
  ...
  case '6': // rain
   ...
   int[][] rainTargets5={{368,354,222},{255,298,90}};
    ...
    cubes[0].led(1000, 0, 0, 255);
    cubes[1].led(1000, 0, 0, 255);
    cubes[2].led(1000, 0, 0, 255);
    cubes[3].led(1000, 0, 0, 255);
    cubes[4].led(1000, 0, 0, 255);
    cubes[5].led(1000, 0, 0, 255);
